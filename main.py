...
def get_args_parser():
    ...
    parser.add_argument(
        ...
        default="/root/autodl-tmp/H-Deformable-DETR/configs/two_stage/deformable-detr-baseline/36eps/swin/swin_tiny_patch4_window7_224.pth",
        type=str,
    )
    ...
    parser.add_argument("--coco_path", default="/root/NWPUVHR10", type=str)##VEDAI_512_coco / NWPUVHR10
    ...
    parser.add_argument("--seed", default=42, type=int)##42##114514##3407
    parser.add_argument("--resume", default="", help="resume from checkpoint")##预训练文件
    parser.add_argument(
...
def main(args):
    ...
    if args.resume and os.path.exists(args.resume):
        ...
        if (
            ...
            if(checkpoint["epoch"] + 1 < args.epochs):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir:
            ...
            if (epoch + 1) % args.lr_drop == 0 or (epoch + 1) % 5 == 0 or (epoch + 1)  >= 30:
